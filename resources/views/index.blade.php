...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Clinic Management</a>
                ...
                <div class="container my-4">
                    <div class="row text-center">
                        <div class="col-md-4 mb-4">
                            ...
                            <img class="my-3 rounded-circle" alt="" width="250 px" src={{asset('assets/img/admin.png')}}
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <img class="my-3 rounded-circle" alt="100x100" width="250 px" src={{asset('assets/img/doctor.jpg')}}
                                data-holder-rendered="true">
                            <a class="btn btn-light btn-xl js-scroll-trigger" href={{route('doctor_login')}}>Login</a>
                        </div>
                        <div class="col-md-4 mb-4">

                            <h2 class="my-2 h2">Receptionist</h2>

                            <img class="my-3 rounded-circle" alt="100x100" width="250 px" src={{asset('assets/img/receptionist.jpg')}}
                                 data-holder-rendered="true">
                            <a class="btn btn-light btn-xl js-scroll-trigger" href={{route('receptionist_login')}}>Login</a>
                        </div>
                    </div>
